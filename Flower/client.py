...
if __name__ == "__main__":
    ...
    variable_list = sys.argv[3].split(',')
    X_train, y_train, num_features = utils.get_dat_csv(file_name, directory, variable_list)
    ...
    utils.set_initial_params(model, n_classes=2, n_features=num_features)
